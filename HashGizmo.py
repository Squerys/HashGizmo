...
print ("""
   _                ___       _.--.
    ...
    `-'" `"\_  ,_.-;_.-\_ ',     
       ...
       {_.-``-'         {_/  _    _           _      _____ _                     
                            | |  | |         | |    / ____(_)                    
                            | |__| | __ _ ___| |__ | |  __ _ _____ __ ___   ___  
                            |  __  |/ _` / __| '_ \| | |_ | |_  / '_ ` _ \ / _ \  
                            | |  | | (_| \__ \ | | | |__| | |/ /| | | | | | (_) |
                            |_|  |_|\__,_|___/_| |_|\_____|_/___|_| |_| |_|\___/ 
                                                      
                                                       """)
                                                      
                                                      
print(" Python Hash-Breaker")
print(" Version Beta")
...
def info():
    ...
    print("[*] Examples:")
    print("[>] ./HashGizmo.py -h <hash> -t md5 -w DICT.txt")
    print("[>] ./HashGizmo.py -h <hash> -t sha384 -n -v")
    print("[*] Supported Hashes:")
    print("[>] md5, sha1, sha224, sha256, sha384, sha512")
    print("[*] C'est tout faut pas deconner!\n")
...
def main(argv):
    ...
    try:
        ...
        print('[*] ./HashGizmo.py -t <type> -h <hash> -w <wordlist>')
        print('[*] Type ./HashGizmo.py -i for information')
        sys.exit(1)
    for opt, arg in opts:
        if opt == '-i':
            info()
